...
(function ($) {
	$.extend($.validator.messages, {
		...
		email: "Por favor, escribe una dirección de correo v&aacute;lida",
		...
		number: "Por favor, escribe un número entero v&aacute;lido.",
		digits: "Por favor, escribe sólo dígitos.",
		creditcard: "Por favor, escribe un número de tarjeta v&aacute;lido.",
